...
class TestRepr(unittest.TestCase):
    ...
    def test_process_string_for_link(self):
        ...
        zenodo_url = 'https://zenodo.org/record/8357399'
        img_url = f'https://zenodo.org/badge/DOI/10.5281/zenodo.8357399.svg'
        self.assertEqual(f'<a href="{zenodo_url}"><img src="{img_url}" alt="DOI"></a>',
                         process_string_for_link(zenodo_url)[0])

        zenodo_url = 'https://doi.org/10.5281/zenodo.8357399'
        img_url = f'https://zenodo.org/badge/DOI/10.5281/zenodo.8357399.svg'
        self.assertEqual(f'<a href="{zenodo_url}"><img src="{img_url}" alt="DOI"></a>',
                         process_string_for_link('10.5281/zenodo.8357399')[0])
