...
The package `wrapper` adds additional functionalities to the core HDF5-interface, which is implemented in the
...
The package `wrapper` provides classes that ar inherited from the interface classes of `h5py`. They are
