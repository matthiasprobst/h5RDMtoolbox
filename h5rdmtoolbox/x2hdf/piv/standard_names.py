...
pivview_translation = StandardNameTableTranslation('pivview', pivview_to_standardnames_dict)
pivview_translation.register(StandardNameTable.load_registered('piv-v1'), overwrite=True)
...
pivview_to_cgns_dict = {'time': 'Time',
                        ...
                        'vw': 'ReynoldsStressYZ',
                        'ww': 'ReynoldsStressZZ'}
pivview2cgns_translation = StandardNameTableTranslation('pivview', pivview_to_standardnames_dict)
pivview2cgns_translation.register(StandardNameTable.load_registered('cgns-v1'), overwrite=True)
